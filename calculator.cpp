                     ...
                     int nCmdShow)
{
    ...
    wincl.hbrBackground = CreateSolidBrush(RGB(128, 255, 0));
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)                  /* handle the messages */
    {
     ...
     char buffer1[100], buffer2[100], result[100];
     double val1, val2;
     float sum;
            ...
            switch(LOWORD(wParam))
            {
               case 1:
                ...
                GetWindowText(TextBox1, buffer1, 100);
                GetWindowText(TextBox2, buffer2, 100);
